...
export default function PdfToolsPage() {
  ...
  const renderTool = () => {
    switch (activeTool) {
      case "pdf-to-word":
        return <FileDropzone tool="pdf-to-word" onBack={() => setActiveTool(null)} messages={msgs.tools.pdfToWord} commonMessages={cm} endpoint="/tools/pdf/api/pdf-to-word" accept=".pdf" multiple={false} />;
      case "compress":
        return <FileDropzone tool="compress" onBack={() => setActiveTool(null)} messages={msgs.tools.compress} commonMessages={cm} endpoint="/tools/pdf/api/compress-pdf" accept=".pdf" multiple={false} />;
      case "merge":
        return <FileDropzone tool="merge" onBack={() => setActiveTool(null)} messages={msgs.tools.merge} commonMessages={cm} endpoint="/tools/pdf/api/merge-pdf" accept=".pdf" multiple={true} />;
      default: return null;
    }
  };
